        ...
        async function fetchUserInfo() {
            ...
            try {
                const response = await fetch(`http://localhost:3000/api/user-info/${username}`);
                if (!response.ok) {
        ...
        async function addMaterial() {
            ...
            if (name && description) {
                await fetch(`${apiBaseUrl}/api/materials`, {
                    method: "POST",
                    headers: {
                        "Content-Type": "application/json"
                    },
        ...
        async function removeMaterial(name) {
            await fetch(`${apiBaseUrl}/api/materials/${name}`, {
                method: "DELETE"
            });
            fetchMaterials();
        }
        ...
        async function updateScoreLimit() {
            ...
            if (!isNaN(scoreLimit)) {
                await fetch(`${apiBaseUrl}/score-limit`, {
                    method: "POST",
                    headers: {
                        "Content-Type": "application/json"
                    },
